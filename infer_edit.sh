...
.venv/bin/python examples/editing/inference.py \
    --model_path /models/SenseNova-U1-8B-MoT-Layered \
    ...
    --profile
# /datasets/codes_zsqiao/FlashNFT/dataset/dpo_v2/00319_将红色方框中的文字修改为：_长兴明德电子科技_，然后去掉红色方框_col2_1_original.jpeg
