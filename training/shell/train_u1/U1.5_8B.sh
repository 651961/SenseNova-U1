...
export MODEL_NAME_OR_PATH=${MODEL_NAME_OR_PATH:-"/models/SenseNova-U1.5-8B-MoT"}
export VOCAB_FILE=${VOCAB_FILE:-"/models/SenseNova-U1.5-8B-MoT"}
export TOKENIZER_PATH=${TOKENIZER_PATH:-"/models/SenseNova-U1.5-8B-MoT"}
